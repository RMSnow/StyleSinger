...
class StyleSingerInfer:
    ...
    def preprocess_input(self, inp):
        ...
        inp.update(
            {"item_name": inp["name"], "ph_token": ph_token, "wav_fn": ref_audio}
        )
        ...
        f0 = (
            parselmouth.Sound(wav, hparams["audio_sample_rate"])
            .to_pitch_ac(
    ...
    def run_gtsinger_eval(cls):
        ...
        ## Save ##
        save_root = "/storage/zhangxueyao/workspace/SpeechGenerationYC_ckpts/ckpts/vevo2/baselines/stylesinger/svs"
        ...
        for group in ["gtsinger_svs_zh", "gtsinger_svs_en"]:
            ...
            for evalset_item in tqdm(evalset, desc=f"Processing {group}"):
                output_path = os.path.join(
                    save_dir,
                    "{}-{}-{}".format(
                        "stylesinger", group, evalset_item["output_path"]
                    ),
                )
                ...
                inp["name"] = inp["gen_name"]
                inp["ref_audio"] = item["wav_fn"]
                inp["ph"] = item["ph"]
                inp["note_dur"] = item["ep_notedurs"]
                inp["note"] = item["ep_pitches"]
                inp["note_type"] = item["ep_types"]
...
if __name__ == "__main__":
    ...
    StyleSingerInfer.run_gtsinger_eval()
